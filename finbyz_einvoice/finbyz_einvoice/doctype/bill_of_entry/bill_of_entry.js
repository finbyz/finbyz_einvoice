    ...
    refresh(frm) {
            ...
            frm.add_custom_button(
                ...
                () => {
                    frappe.model.open_mapped_doc({
                        method: "finbyz_einvoice.finbyz_einvoice.doctype.bill_of_entry.bill_of_entry.make_journal_entry_for_payment",
                        frm: frm,
                    });
                },
                __("Create")
        ...
        if (frm.doc.docstatus === 1 && frm.doc.total_customs_duty > 0) {
            frm.add_custom_button(
                ...
                () => {
                    frappe.model.open_mapped_doc({
                        method: "finbyz_einvoice.finbyz_einvoice.doctype.bill_of_entry.bill_of_entry.make_landed_cost_voucher",
                        frm: frm,
                    });
                },
                __("Create")
