...
from finbyz_einvoice.gst_india.constants import GST_INVOICE_NUMBER_FORMAT
from finbyz_einvoice.gst_india.overrides.transaction import (
    ignore_gst_validations,
    validate_mandatory_fields,
    validate_transaction,
)
from finbyz_einvoice.gst_india.utils import is_api_enabled
from finbyz_einvoice.gst_india.utils.e_invoice import validate_e_invoice_applicability
from finbyz_einvoice.gst_india.utils.transaction_data import (
...
def on_submit(doc, method=None):
    ...
    if (
        ...
        frappe.enqueue(
            "finbyz_einvoice.gst_india.utils.e_invoice.generate_e_invoice",
