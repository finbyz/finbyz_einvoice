...
from finbyz_einvoice.gst_india.constants import (
    EXPORT_TYPES,
    GST_CATEGORIES,
    OVERSEAS_GST_CATEGORIES,
)
from finbyz_einvoice.gst_india.constants.e_invoice import (
    CANCEL_REASON_CODES,
    ITEM_LIMIT,
)
from finbyz_einvoice.gst_india.utils import (
    is_api_enabled,
    load_doc,
    parse_datetime,
    send_updated_doc,
...
def enqueue_bulk_e_invoice_generation(docnames):
    ...
    rq_job = frappe.enqueue(
        "finbyz_einvoice.gst_india.utils.e_invoice.generate_e_invoices",
        queue="long",
