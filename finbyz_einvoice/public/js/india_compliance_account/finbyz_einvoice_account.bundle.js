...
frappe.provide("finbyz_einvoice.pages");
finbyz_einvoice.pages.IndiaComplianceAccountPage = IndiaComplianceAccountPage;

frappe.provide("finbyz_einvoice.gst_api");
finbyz_einvoice.gst_api.call = async function (endpoint, options) {
    try {
