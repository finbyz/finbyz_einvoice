...
from finbyz_einvoice.audit_trail.setup import setup_fixtures as setup_audit_trail
from finbyz_einvoice.gst_india.constants import BUG_REPORT_URL
from finbyz_einvoice.gst_india.setup import after_install as setup_gst
from finbyz_einvoice.income_tax_india.setup import after_install as setup_income_tax
...
def after_install():
    try:
        ...
        click.secho(
            (
                "Installation for Finbyz Einvoice failed due to an error."
    ...
    click.secho("Thank you for installing Finbyz Einvoice!", fg="green")
...
def run_post_install_patches():
    ...
    try:
        for patch in POST_INSTALL_PATCHES:
            frappe.get_attr(f"finbyz_einvoice.patches.post_install.{patch}.execute")()
